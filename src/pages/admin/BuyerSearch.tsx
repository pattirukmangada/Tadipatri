  ...
  return (
    <div className="space-y-5">
      ...
      <div className="card bg-amber-50 border border-amber-200 py-2.5 px-4 text-xs text-amber-800 flex items-center gap-2">
        ...
        Enter a flat hamali amount per buyer. Net Amount = (Gross × 0.97) + Hamali. Same formula is used in Buyer Ledger debit.
      </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {groupedBuyers.map((r, i) => {
                      ...
                      const netAmt    = (r.total_amount * 0.97) + hamaliAmt  // (gross × 0.97) + hamali
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Net Amount = (gross × 0.97) + hamali */}
                          <td className="py-3 px-4 text-right tabular-nums">
                            {hamaliAmt > 0 ? (
                              <div>
                                <div className="font-bold text-blue-700">{formatCurrency(netAmt)}</div>
                                <div className="text-[10px] text-gray-400 mt-0.5">
                                  ({formatCurrency(r.total_amount)} × 0.97) + {formatCurrency(hamaliAmt)}
                                </div>
                              </div>
                            ) : (
                              <div>
                                <div className="font-bold text-blue-700">{formatCurrency(r.total_amount * 0.97)}</div>
                                <div className="text-[10px] text-gray-400 mt-0.5">
                                  {formatCurrency(r.total_amount)} × 0.97
                                </div>
                              </div>
                            )}
                          </td>
